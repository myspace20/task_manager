...
import com.task.task_manager_rest.exceptions.InvalidCredentialsException;
import com.task.task_manager_rest.exceptions.ResourceExistException;
...
public class AuthService implements IAuthService {
    ...
    public UserResponseDto register(CreateUserDto createUserDto) {
        if (userRepository.findByUsername(createUserDto.getUsername()).isPresent()) {
            throw new ResourceExistException("Username is already taken");
        }
